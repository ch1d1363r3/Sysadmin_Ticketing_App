    					...
    					<tr>
    				        ...
    				        <td>
    	   	    			";
    							...
    							if ($_GET['page']=='plugins/availability/index') {include('plugins/availability/stats/graph_bar_stacked.php');}
								if (($_GET['page']=='plugins/availability/index') || ($_GET['page']=='plugins/availability/print') ) {echo "<div class=\"ml-2\"  id=\"$container\" style=\"min-width: 300px; height: 300px; margin: 0 auto\"></div>";}
    							echo "
    	   	    			</td>
       	    			</tr>
       	    		</table>
