	...
	<table border="0" width="';if($mobile) {echo '310';} else {echo '732';} echo '" >
		<tr>
			...
			<td >	
				...
				echo '
				<button class="btn btn-sm btn-success ml-2" title="'.$button_text.'" name="modify" value="modify" type="submit" id="add_thread_btn"><i class="fa '.$button_icon.'"><!----></i> '.$button_text.'</button>
			</td>
		</tr>
	</table>
	';
