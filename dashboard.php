...
if(!isset($_POST['date_modif'])) $_POST['date_modif']=$_GET['date_modif']; 
...
///// SQL QUERY
	...
	if($keywords && $reload==0)
	{
		...
		if($_SESSION['profile_id']==0  && $_GET['userid']!='%' && $_GET['userid'] && $_GET['state']!='meta')
		{
		...
		if($rparameters['user_company_view'] && $rright['side_company'])
		{
		...
		if($_GET['view']=='activity')
		{
			...
			$where.="AND tincidents.date_create LIKE '$_POST[date_create]%' AND tincidents.date_res LIKE '$_POST[date_res]%' AND tincidents.date_modif LIKE '$_POST[date_modif]%'";
		}
		//special case to filter technician group is send
...
<div class="page-header position-relative">
	<h1 class="page-title text-primary-m2">
		...
		else 
		{
			...
			{
				echo '<i class="fa fa-ticket-alt text-primary-m2"><!----></i> '.T_('Vos tickets observés');
			}
...
?>
<div class="mt-4 mt-lg-0 card bcard h-auto overflow-visible shadow border-0"> <!-- chosen overflow fix orig overflow-hidden --> 
	<div class="table-responsive overflow-visible"> <!-- chosen overflow fix orig style="overflow-y: hidden;" --> 
		<div class="col-xs-12">
				...
				<thead class="text-dark-m3 bgc-grey-l4">
					...
					<tr class="bgc-white text-secondary-d3 text-95">
						<td class="text-center">
							<input form="filter" class="form-control" name="ticket" onchange="submit();" type="text" style="width:80px" value="<?php if($_POST['ticket']!='%') {echo $_POST['ticket'];} ?>" />
						</td>			
						<?php
							...
							if($_SESSION['profile_id']!=0 || $_SESSION['profile_id']!=4 || $_GET['userid']=='%')
							{
								echo '
								<td class="text-center" >
									<select form="filter" class="chosen-select" data-placeholder=" " style="width:100px;" name="technician" onchange="submit()" >
										<option value="%"></option>
							...
							if($rright['dashboard_col_company'])
							{
								echo '
								<td class="text-center" >
									<select form="filter" class="chosen-select" data-placeholder=" " style="width:100px;" name="company" onchange="submit()">
										<option value="%"></option>';
							...
							if(($_SESSION['profile_id']==0 || $_SESSION['profile_id']==3 || $_SESSION['profile_id']==4) || ($rright['side_all'] && ($_GET['userid']=='%'|| $keywords!='')) || ($rparameters['user_company_view']!=0 && $_GET['userid']=='%' && ($rright['side_company'] || $keywords!=''))) 
							{
								echo '
								<td class="text-center" >
									<select form="filter" class="chosen-select" data-placeholder=" " style="width:100% !important;" name="user" id="user" onchange="submit()">
										<option value="%"></option>
										<option value="0">'.T_('Aucun').'</option>';
										//display users list
										if($join)
							...
							if($rright['dashboard_col_user_service']) 
							{
								echo'
								<td class="text-center">
									<select form="filter" class="form-control" style="width:60px" name="sender_service" onchange="submit()">
										<option value="%"></option>
										';
											if($join)
											{
							...
							if($rright['dashboard_col_type']) 
							{
								echo '
									<td class="text-center" >
										<select form="filter" class="form-control" style="width:92px" name="type" onchange="submit()">
											<option value="%"></option>';
											//display type list
							...
							if($rright['dashboard_col_category']) 
							{
								echo '
								<td class="text-center" >
									<select form="filter" class="form-control" style="width:65px" name="category" onchange="submit()" >
										<option value="%"></option>
										';
											if($join)
							...
							if($rright['dashboard_col_subcat']) 
							{
								echo'
								<td class="text-center" >
									<select form="filter" class="form-control" style="width:60px" name="subcat" onchange="submit()">
										<option value="%"></option>
										';
											if($_POST['category']!='%')
											{
							...
							if($rright['dashboard_col_asset']) 
							{
								echo '
								<td class="text-center" >
									<select form="filter" class="form-control" style="width:65px" name="asset" onchange="submit()" >
										<option value="%"></option>
										';
											if($join)
						...
						<?php if($rparameters['ticket_places']==1){ ?>
							<td class="text-center" >
								<select form="filter" class="form-control" style="width:65px" name="place" onchange="submit()" >
									<option value="%"></option>
									<?php
									if($join)
						...
						<?php
							...
							if($rright['dashboard_col_service']) 
							{
								echo'
								<td class="text-center" >
									<select form="filter" class="form-control" style="width:60px" name="service" onchange="submit()">
										<option value="%"></option>
										';
							...
							if($rright['dashboard_col_agency']) 
							{
								echo'
								<td class="text-center" >
									<select form="filter" class="form-control" style="width:60px" name="agency" onchange="submit()">
										<option value="%"></option>
										';
											if($join)
						...
						<?php
							...
							if($rright['dashboard_col_date_create'])
							{
								...
								echo '
								<td class="text-center">
									<input form="filter" class="form-control" title="'.T_('La date doit être au format JJ/MM/AAAA').'" name="date_create" style="max-width:130px;" onchange="submit();" type="text"  value="'; if($_POST['date_create']!='%' && !$_GET['view']) {echo $_POST['date_create'];} echo '" />
								</td>
								';
							}
							...
							if($rright['dashboard_col_date_hope'])
							{
								...
								echo '
								<td class="text-center">
									<input form="filter" class="form-control" title="'.T_('La date doit être au format JJ/MM/AAAA').'" name="date_hope" style="max-width:130px;" onchange="submit();" type="text"  value="'; if($_POST['date_hope']!='%' && !$_GET['view']) {echo $_POST['date_hope'];} echo '" />
								</td>
								';
							}
							...
							if($rright['dashboard_col_date_res'])
							{
								...
								echo '
								<td class="text-center" >
									<input form="filter" class="form-control" title="'.T_('La date doit être au format JJ/MM/AAAA').'" name="date_res" style="max-width:130px;" onchange="submit();" type="text"  value="'; if($_POST['date_res']!='%' && !$_GET['view']) {echo $_POST['date_res'];} echo '" />
								</td>
								';
							...
							if($rright['dashboard_col_date_modif'])
							{
								...
								echo '
								<td class="text-center">
									<input form="filter" class="form-control" title="'.T_('La date doit être au format JJ/MM/AAAA').'" name="date_modif" style="max-width:130px;" onchange="submit();" type="text"  value="'; if($_POST['date_modif']!='%' && !$_GET['view']) {echo $_POST['date_modif'];} echo '" />
								</td>
								';
							}
							...
							if($rright['dashboard_col_time'])
							{
								echo '
								<td class="text-center">
									<input form="filter" class="form-control" title="'.T_('Le temps doit être renseigné en minutes').'" name="time" style="max-width:130px;" onchange="submit();" type="text"  value="'; if($_POST['time']!='%' && !$_GET['view']) {echo $_POST['time'];} echo '" />
								</td>
								';
							}
						?>
						<td class="text-center">
							<select form="filter" class="form-control" style="width:50px" id="state" name="state" onchange="submit()" >	
								<option value=""></option>
								<?php
								if($join)
						...
						<?php
							...
							if($rright['dashboard_col_priority'])
							{
								echo '
								<td class="text-center">
									<select form="filter" class="form-control" style="width:45px" id="priority" name="priority" onchange="submit()">
										<option value=""></option>
										';
										if($join)
							...
							if($rright['dashboard_col_criticality']) 
							{
								echo '
								<td class="text-center">
									<select form="filter" class="form-control" style="width:50px" id="criticality" name="criticality" onchange="submit()">
										<option value=""></option>
										';
										if($join)
						...
						{ 
							...
							echo '
								<tr class="bgc-h-default-l3 d-style">
									...
									//display place
									if($rparameters['ticket_places']){echo '<td class="text-center" onclick="document.location=\' '.$open_ticket_link.' \'"><a class="td" href="'.$open_ticket_link.'">'.T_($nameplace).'</a></td>';}
									//display service
									...
									//display date create
									if($rright['dashboard_col_date_create']){echo "<td class=\"text-center\" onclick=\"document.location='$open_ticket_link'\"><a class=\"td\" href=\"$open_ticket_link\">$rowdate_create</a></td>";}
									//display date hope
									...
									if($rright['dashboard_col_date_res']){echo "<td class=\"text-center\" onclick=\"document.location='$open_ticket_link'\"><a class=\"td\" href=\"$open_ticket_link\">$rowdate_res</a></td>";}
									//display resolution date
									if($rright['dashboard_col_date_modif']){echo "<td class=\"text-center\" onclick=\"document.location='$open_ticket_link'\"><a class=\"td\" href=\"$open_ticket_link\">$rowdate_modif</a></td>";}
									//display time
									...
									//display state
									echo '<td class="text-center" onclick="document.location=\''.$open_ticket_link.'\'"><a class="td" href="'.$open_ticket_link.'"><span class="'.$resultstate['display'].'" title="'.T_($resultstate['description']).'">'.T_($resultstate['name']).'</span></a></td>';
									//display priority
...
if($_GET['view']=='activity')
{
	...
	if($ruser['language']=='it_IT') {echo '<script src="./components/moment/locale/it.js" charset="UTF-8"></script>';} 
	echo '
