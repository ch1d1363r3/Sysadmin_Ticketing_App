            	                 ...
            	                 if($_POST['password2']==$_POST['password']) {
									...
									if($exist_user==true)
									{
										...
										if(!$msg_error && !$msg_success)
										{
											...
											$qry=$db->prepare("INSERT INTO `ttoken` (`date`,`token`,`action`,`user_id`) VALUES (NOW(),:token,'subscription',:user_id)");
				...
				<div role="main" class="main-content ">
					<div class="justify-content-center pb-2">
						...
						<div class="d-flex flex-column align-items-center justify-content-start">
							<h1 class="mt-5">
								<img title="GestSup" width="45" src="images/logo_gestsup_white.svg" />
