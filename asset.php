						...
						<div class="row">
							<div class="col-lg-9">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<select class="form-control <?php if($mobile){echo 'col-7';} else {echo 'col-3';} if($mobile==0) {echo ' chosen-select ';}?>" id="user" name="user">
											<?php
							...
							<div class="col-lg-3" >
								...
								<?php 
									...
									if($row['image']!='') 
									{
										...
										if(file_exists("./upload/asset/model/$row[image]"))
										{
