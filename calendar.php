  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
	...
	eventContent: function(arg) {
		...
		if (arg.event.extendedProps.isHTML) {
			divEl.innerHTML = '<a style="color:#FFF;" href="index.php?page=ticket&id='+arg.event.borderColor+'">'+htmlTitle+'</a>'
		} else {
			divEl.innerHTML = '<a style="color:#FFF;"  href="index.php?page=ticket&id='+arg.event.borderColor+'">'+arg.event.title+'</a>'
		}
		...
		bootbox.prompt({ 
			...
			callback: function (title) {
				if (title !== null) {
					...
					$.ajax({
						url: 'ajax/calendar.php',
						data: 'action=add_event&title='+title+'&start='+start+'&end='+end+'&allday='+allDay+'&technician='+ <?php if($_POST['technician']=='%') {echo $_POST['technician']=$_SESSION['user_id'];} else {echo $_POST['technician'];}; ?>,
						type: "POST",
