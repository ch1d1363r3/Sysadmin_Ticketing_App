		...
		elseif(!$_POST['captcha'] || $_POST['captcha']!=$_SESSION['code']){$msg_error=T_("Captcha invalide, merci de recopier les caractères présents dans l'image");}
			...
			if($user)
			{
				...
				if($mail_number[0]==1)
				{
					...
					$qry=$db->prepare("INSERT INTO `ttoken` (`date`,`token`,`action`,`user_id`) VALUES (NOW(),:token,'forgot_pwd',:user_id)");
				...
				<div role="main" class="main-content ">
					<div class="justify-content-center pb-2">
						...
						<div class="d-flex flex-column align-items-center justify-content-start">
							<h1 class="mt-5">
								<img title="GestSup" width="45" src="images/logo_gestsup_white" />	
